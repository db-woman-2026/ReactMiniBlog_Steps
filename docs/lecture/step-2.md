...
`App.jsx` 안에 있던 내용을 Header, HomePage, Footer로 나누고 import로 다시 연결합니다. 기능은 추가하지 않습니다.
...
Header와 Footer 중 하나의 문구를 props로 전달하려면 어느 경계를 바꿀지 적습니다. 결과와 확인 방법을 한 문장으로 기록합니다. 실험값은 검사를 마치면 원래대로 복구합니다.
