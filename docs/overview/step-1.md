...
> Windows 11에서는 [환경 준비](../windows-11.md) <span class="print-reference" data-print-reference="true">(React · Windows 11 x64 개발 환경 준비 · 1. Windows Terminal 설치)</span>를 먼저 확인합니다. Windows Terminal의 PowerShell에서 실행합니다.
